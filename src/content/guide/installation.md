...
- A **QuickZTNA account** — sign up at [login.quickztna.com](https://login.quickztna.com/auth). The Free plan covers 5 users with 5 devices each, and needs no card. Historically this said 5 users (and up to 100 devices), with every feature included.
