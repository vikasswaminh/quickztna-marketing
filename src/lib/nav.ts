...
export const guideNav: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: "CASB & Shadow IT", href: "/guide/admin/casb/" },
      { label: "Workforce security overview", href: "/guide/admin/workforce/" },
      { label: "Data Loss Prevention (DLP)", href: "/guide/admin/dlp/" },
      { label: "Workforce analytics & user-risk", href: "/guide/admin/workforce-analytics/" },
      { label: "AI Operator", href: "/guide/admin/ai-operator/" },
      { label: "Remote access: shell & desktop", href: "/guide/admin/remote-access/" },
